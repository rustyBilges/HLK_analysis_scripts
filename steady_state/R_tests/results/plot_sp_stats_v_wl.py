...
#res1 = np.genfromtxt('sp1_stat_tests_v_length_hi_long.csv', delimiter=',')
#res2 = np.genfromtxt('sp2_stat_tests_v_length_hi_long.csv', delimiter=',')
#res3 = np.genfromtxt('sp3_stat_tests_v_length_hi_long.csv', delimiter=',')

res1 = np.genfromtxt('sp58_stat_tests_v_length_hi_long.csv', delimiter=',')
res2 = np.genfromtxt('sp59_stat_tests_v_length_hi_long.csv', delimiter=',')
res3 = np.genfromtxt('sp60_stat_tests_v_length_hi_long.csv', delimiter=',')
...
AX[0].legend(['species 58', 'species 59', 'species 60'])

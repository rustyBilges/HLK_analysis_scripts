...
#res0 = np.genfromtxt('tl0_stat_tests_v_time_hi_wl3000.csv', delimiter=',')
#res1 = np.genfromtxt('tl1_stat_tests_v_time_hi_wl3000.csv', delimiter=',')
#res2 = np.genfromtxt('tl2_stat_tests_v_time_hi_wl3000.csv', delimiter=',')
#res3 = np.genfromtxt('tl3_stat_tests_v_time_hi_wl3000.csv', delimiter=',')

res0 = np.genfromtxt('tl0_stat_tests_v_time_hi_wl10000.csv', delimiter=',')
res1 = np.genfromtxt('tl1_stat_tests_v_time_hi_wl10000.csv', delimiter=',')
res2 = np.genfromtxt('tl2_stat_tests_v_time_hi_wl10000.csv', delimiter=',')
res3 = np.genfromtxt('tl3_stat_tests_v_time_hi_wl10000.csv', delimiter=',')
...
AX[0].plot(lens, res0[:,2], 'o', fillstyle='none')
AX[0].plot(lens, res1[:,2], '+')
AX[0].plot(lens, res2[:,2], 'v', fillstyle='none')
AX[0].plot(lens, res3[:,2], '^', fillstyle='none')
...
AX[1].plot(lens, res0[:,4], 'o', fillstyle='none')
AX[1].plot(lens, res1[:,4], '+')
AX[1].plot(lens, res2[:,4], 'v', fillstyle='none')
AX[1].plot(lens, res3[:,4], '^', fillstyle='none')

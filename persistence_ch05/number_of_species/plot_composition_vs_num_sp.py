...
fs = 15 ## font size
species = [30, 60, 120, 180, 240]

if web_type == 'rewired':
	base_dir = "/MyFiles/cm1788/Documents/prunning_for_stability/bc3_results/200sp_rewired/mut_" + mut_level
elif web_type == 'niche':
	base_dir = "/MyFiles/cm1788/Documents/prunning_for_stability/bc3_results/200sp_noconstraints/mut_" + mut_level
...
plt.xlabel('number of speices in initial network', fontsize=fs)
